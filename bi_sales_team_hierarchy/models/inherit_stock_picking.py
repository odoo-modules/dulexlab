...
class InheritedStockPicking(models.Model):
    ...
    driver_name = fields.Many2one('res.partner', string="Driver Name", related='sale_id.driver_name')
    car_number = fields.Many2one('fleet.vehicle', string="Car Number", related='sale_id.car_number')